...
const createSchema = z.object({
  ...
  regionId: z.string({
    required_error: "L'identifiant de la region membre est requise.",
  }),
  regionCapitalId: z.string().optional(),
});
    ...
    try {
      ...
      const department = await prisma.department.create({
        data: {
          ...
          regionId: bodyPayload.regionId,
          regionCapitalId: bodyPayload.regionCapitalId,
          updatedAt: new Date(),
        },
      });
